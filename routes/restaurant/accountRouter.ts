...
import { uploadRestaurantHero } from "../../middleware/upload.middleware";
...
accountRouter.put("/account", uploadRestaurantHero, RestaurantProfileController.updateRestaurantAccount);
