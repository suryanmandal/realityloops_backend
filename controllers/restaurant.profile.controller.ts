...
export class RestaurantProfileController {
  ...
  static async getRestaurantAccount(req: Request, res: Response): Promise<Response> {
    try {
      ...
      const result = await RestaurantAdminService.getCurrentRestaurantAccount(restaurantId, domain);
  ...
  static async updateRestaurantAccount(req: Request, res: Response): Promise<Response> {
    try {
      ...
      const updateData = {
        ...req.body,
        ...(req.file?.path && { heroImage: req.file.path }),
      };

      const result = await RestaurantAdminService.updateCurrentRestaurantAccount(restaurantId, updateData, domain);
